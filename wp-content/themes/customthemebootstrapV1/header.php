...
<!--Navbar-->
<nav class="navbar navbar-expand-lg navbar-light bg-light small custom-nav border-bottom fixed-top mb-5">
  <div class="container">
    ...
    <?php
      ...
      <div class="input-group">
        ...
        <button class="btn btn-sm btn-success" type="submit" id="search-btn">
